...
def translate():
    poscar_in = Poscar()
    poscar_out = Poscar()
    poscar_in.read(os.path.dirname(os.path.realpath(__file__)) + "/source/translate/POSCAR")
    poscar_out.read(os.path.dirname(os.path.realpath(__file__)) + "/source/translate/POSCAR")
    poscar_out.translate(1, 1, 3, 3)
